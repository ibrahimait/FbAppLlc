...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Show Question d'Adhésion</h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">ID Question :  {{$questionad->id_question}}</h4>
                <p class="m-b-sm">ID groupe :  {{$questionad->id_groupe}}</p>  
                <br><br><br>      
            </div>
        </div>
    </div>
    ...
    <div class="profile-container">
                ...
                <div class="tab-content p-0">
                    <div class="tab-pane active show" id="profile-about">
                        <table class="table table-profile">
                            ...
                            <tbody>
                                <tr>
                                    <td class="field">ID Question : </td>
                                    <td class="value">
                                        {{$questionad->id_question}}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        {{$questionad->nb_membres}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">ID groupe :</td>
                                    <td class="value">
                                        {{$questionad->id_groupe}}
                                    </td>
                                </tr>
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">{{$questionad->question}} </div>
                    </li>
                    <li>
                        <div class="field">Réponse 1 :</div>
                        <div class="value">{{$questionad->reponse}} </div>
                    </li>
                    <li>
                        <div class="field">Rponse 2 :</div>
                        <div class="value">{{$questionad->reponse2}} </div>
                    </li>
                    <li>
                        <div class="field">Cookies :</div>
                        <div class="value">{{$questionad->reponse3}} </div>
                    </li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('questionads.edit',$questionad->id_question) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
