...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Campagne</h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">{{$campagne->nom}}</h4>
                <p class="m-b-sm">Campagne {{$campagne->actif_supprime}}</p>
                <a href="{{$campagne->id_campagne}}" class="btn btn-xs btn-primary mb-3">Visiter</a>
    ...
    <div class="profile-container">
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">{{$campagne->date_programmation}}</div>
                    </li>
                    <li>
                        <div class="field">Etat :</div>
                        <div class="value">{{$campagne->etat}}</div>
                    </li>
                    <li>
                        <div class="field">Nombre de likes :</div>
                        <div class="value">{{$campagne->nb_likes}}</div>
                    </li>
                    <li>
                        <div class="field">Nombre de commentaires :</div>
                        <div class="value">
                                {{$campagne->nb_comments}}
                        </div>
                    </li>
                    <li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('campagnes.edit',$campagne->id_campagne) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
