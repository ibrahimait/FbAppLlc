...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card h-100">
            <div class="card-body">
            <form action="{{ route('groupesanssegments.store') }}" method="POST">
            @csrf

                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h5 class="mb-2 text-primary">Information du groupe sans segment</h5>
                    </div>
                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="text-right">
                            ...
                            <a class="btn btn-secondary" href="{{ route('groupesanssegments.index') }}"> Back</a>
                        </div>
                    </div>
                </div>
                </form>
