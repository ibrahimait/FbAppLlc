...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Show Groupe sans segmentation</h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">{{$groupesanssegmentation->nom}}</h4>
                <p class="m-b-sm">Groupe {{$groupesanssegmentation->actif_supprime}}</p>
                <a href="{{$groupesanssegmentation->id_groupe}}" class="btn btn-xs btn-primary mb-3">Visiter</a>
            </div>
        </div>
    </div>
    ...
    <div class="profile-container">
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="value">
                                        {{$groupesanssegmentation->nom}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">ID groupe :</td>
                                    <td class="value">
                                        {{ \Str::limit($groupesanssegmentation->id_groupe , 60) }}                            
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Personnalisation :</td>
                                    <td class="value">
                                        {{$groupesanssegmentation->personnalisation}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Nombre de membres :</td>
                                    <td class="value">
                                        {{$groupesanssegmentation->nb_membres}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Thème :</td>
                                    <td class="value">
                                        {{$groupesanssegmentation->theme}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Type :</td>
                                    <td class="value">
                                        {{$groupesanssegmentation->type}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Statut d'intégration :</td>
                                    <td class="value">
                                        {{$groupesanssegmentation->statut_integration}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Actif/Supprimé :</td>
                                    <td class="value">
                                        {{$groupesanssegmentation->actif_supprime}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Fréquence post par mois :</td>
                                    <td class="value">
                                        {{$groupesanssegmentation->frequence_post_mois}}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">{{$groupesanssegmentation->statut_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Date relevé :</div>
                        <div class="value">{{$groupesanssegmentation->date_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Format groupe :</div>
                        <div class="value">{{$groupesanssegmentation->format_groupe}}</div>
                    </li>
                    <li>
                        <div class="field">Réglementation:</div>
                        <div class="value">{{$groupesanssegmentation->reglementation}}</div>
                    </li>
                    <li>
                        <div class="field">Lieu:</div>
                        <div class="value">
                                {{$groupesanssegmentation->lieu}}
                        </div>
                    </li>
                    <li>
                        <div class="field">Tag recherché :</div>
                        <div class="value">
                            {{$groupesanssegmentation->tag_recherche}}
                        </div>
                    </li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('groupesanssegmentations.edit',$groupesanssegmentation->id) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
