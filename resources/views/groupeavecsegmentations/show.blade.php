...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Show Groupe avec segmentation</h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">{{$groupeavecsegmentation->nom}}</h4>
                <p class="m-b-sm">Groupe {{$groupeavecsegmentation->actif_supprime}}</p>
                <a href="{{$groupeavecsegmentation->id_groupe}}" class="btn btn-xs btn-primary mb-3">Visiter</a>
    ...
    <div class="profile-container">
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="value">
                                        {{$groupeavecsegmentation->nom}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">ID groupe :</td>
                                    <td class="value">
                                        {{ \Str::limit($groupeavecsegmentation->id_groupe , 60) }}                            
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Personnalisation :</td>
                                    <td class="value">
                                        {{$groupeavecsegmentation->personnalisation}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Nombre de membres :</td>
                                    <td class="value">
                                        {{$groupeavecsegmentation->nb_membres}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Thème :</td>
                                    <td class="value">
                                        {{$groupeavecsegmentation->theme}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Type :</td>
                                    <td class="value">
                                        {{$groupeavecsegmentation->type}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Statut d'intégration :</td>
                                    <td class="value">
                                        {{$groupeavecsegmentation->statut_integration}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Actif/Supprimé :</td>
                                    <td class="value">
                                        {{$groupeavecsegmentation->actif_supprime}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Fréquence post par mois :</td>
                                    <td class="value">
                                        {{$groupeavecsegmentation->frequence_post_mois}}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">{{$groupeavecsegmentation->statut_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Date relevé :</div>
                        <div class="value">{{$groupeavecsegmentation->date_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Format groupe :</div>
                        <div class="value">{{$groupeavecsegmentation->format_groupe}}</div>
                    </li>
                    <li>
                        <div class="field">Réglementation:</div>
                        <div class="value">{{$groupeavecsegmentation->reglementation}}</div>
                    </li>
                    <li>
                        <div class="field">Lieu:</div>
                        <div class="value">
                                {{$groupeavecsegmentation->lieu}}
                        </div>
                    </li>
                    <li>
                        <div class="field">Tag recherché :</div>
                        <div class="value">
                            {{$groupeavecsegmentation->tag_recherche}}
                        </div>
                    </li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('groupeavecsegmentations.edit',$groupeavecsegmentation->id) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
