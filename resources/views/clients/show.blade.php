...
@section('content')
<div class="container">
    <h2 style="margin-bottom :25px"> Client</h2>
    ...
    <div id="content" class="content p-0">
        <div class="profile-header">
            ...
            <div class="profile-header-content">
                ...
                <div class="profile-header-info">
                    <h4 class="m-t-sm"></h4>
                    <p class="m-b-sm"></p>
                    <a href="{{ $bdd->id_contact }}" class="btn btn-xs btn-primary mb-3">Visiter</a>
                ...
                <div class="col-md-4 hidden-xs hidden-sm">
                    <ul class="profile-info-list">
                        ...
                        <li>
                            ...
                            <div class="value">{{ $bdd->statut }}</div>
                        </li>
                        <li>
                            <div class="field">Expérience :</div>
                            <div class="value">{{ $bdd->produit }}</div>
                        </li>
                        <li>
                            <div class="field">Nbr Personne :</div>
                            <div class="value">{{ $bdd->nbr_personne }}</div>
                        </li>
                        <li>
                            <div class="field">Nbr Chanson :</div>
                            <div class="value">{{ $bdd->nbr_chanson }}</div>
                        </li>
                        <li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
            ...
            <a href="{{ route('clients.edit', $bdd->id_contact) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
        </div>
    </div>
