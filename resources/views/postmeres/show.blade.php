...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Info Post mère :<?php echo e(" ".$postmere->titre); ?></h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm"> ID post : {{$postmere->id_post}}</h4>
                <p class="m-b-sm">Titre :  {{$postmere->titre}}</p>
                <a href="{{$postmere->id_groupe}}" class="btn btn-xs btn-primary mb-3">Visiter</a>
    ...
    <div class="profile-container">
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">{{$postmere->hashtag}}</div>
                    </li>
                    <li>
                        <div class="field">Porte :</div>
                        <div class="value">{{$postmere->portee}}</div>
                    </li>
                    <li>
                        <div class="field">Interaction :</div>
                        <div class="value">{{$postmere->interaction}}</div>
                    </li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('postmeres.edit',$postmere->id_post) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
