...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Team</h2>
...
<div id="content" class="content p-0">
    ...
    <div class="profile-container">
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('users.edit',$user->id) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
