...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Liste des groupes sans ambassadeurs</h2>
            </div>
                ...
                <h6>Recherche multicritère</h6>
                    ...
                    <div class="row">
                            <div class="col-lg-40">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-30 p-0">
                                        ...
                                        <button type="button" class="btn btn-danger wrn-btn"><a href="{{ route('groupesansambassadeurs') }}">Reset</a></button>
                                    </div>
                        ...
                        <select data-trigger="" name="nm" style="width : 50px"  onchange="this.form.submit();">
                            <option disabled selected>{{$groupesansambassadeurs->perPage()}} </option>
                            <option>10</option>
                            <option>25</option>
                            <option>50</option>
                            <option>100</option>
...
<!-- Recherche Multicritères FIN -->
            ...
            <br>
                <a class="btn btn-success" href="{{ route('groupesansambassadeurs.create') }}"> Ajouter</a>
   ...
   <br><br>
    ...
    @endif
    <div class="table">
    <p> Il y'a : {{ $groupesansambassadeurs->total() }} Groupes</p>
        <table class="table">
            ...
            @if($groupesansambassadeurs->count())
            @foreach ($groupesansambassadeurs as $key => $value)
            <tr>
                <th  scope="row">{{++$i}}</th>
