...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">{{$utilisateur->Nom}} {{$utilisateur->preNom}}</h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm"> {{$utilisateur->preNom}} {{$utilisateur->Nom}}</h4>
                <p class="m-b-sm">ID utilisateur :  {{$utilisateur->id_utilisateur}}</p>
            <br><br><br>
            </div>
        </div>
    </div>
    ...
    <div class="profile-container">
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td class="field">profil :</td>
                                    <td class="value">
                                        {{$utilisateur->profil}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">URL Utilisateur :</td>
                                    <td class="value">
                                        {{$utilisateur->url_utilisateur}}
                                    </td>
                                </tr>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('utilisateurs.edit',$utilisateur->id_utilisateur) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
