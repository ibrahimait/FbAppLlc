...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Show Adhésion manuelle</h2>
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">{{$adhmanuelle->nom}}</h4>
                <p class="m-b-sm">Groupe {{$adhmanuelle->actif_supprime}}</p>
                <a href="{{$adhmanuelle->id_groupe}}" class="btn btn-xs btn-primary mb-3">Visiter</a>
    ...
    <div class="profile-container">
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        {{ \Str::limit($adhmanuelle->id_groupe , 60) }}                            
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Personnalisation :</td>
                                    <td class="value">
                                        {{$adhmanuelle->personnalisation}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Nombre de membres :</td>
                                    <td class="value">
                                        {{$adhmanuelle->nb_membres}}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        {{$adhmanuelle->statut_integration}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Actif/Supprimé :</td>
                                    <td class="value">
                                        {{$adhmanuelle->actif_supprime}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Fréquence post par mois :</td>
                                    <td class="value">
                                        {{$adhmanuelle->frequence_post_mois}}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">{{$adhmanuelle->statut_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Date relevé :</div>
                        <div class="value">{{$adhmanuelle->date_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Format groupe :</div>
                        <div class="value">{{$adhmanuelle->format_groupe}}</div>
                    </li>
                    <li>
                        <div class="field">Réglementation:</div>
                        <div class="value">{{$adhmanuelle->reglementation}}</div>
                    </li>
                    <li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('adhmanuelles.edit',$adhmanuelle->id) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
