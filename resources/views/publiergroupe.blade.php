        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="advance-search">
                <div class="form-row" style="font-size : 10px">            
                        <div class="col">
                            <div class="input-select">
                            <input class="form-control" type="number" name="tag" id="tag" placeholder="ID compagne">                          
                            </div>
                        </div>

                        <div class="col">
                            <div class="input-select">
                            <input class="form-control" type="number" name="tag" id="tag" placeholder="ID ambassadeur">                        
                            </div>
                        </div>
                </div>
            </div>  
            ...
            <div class="advance-search" style="margin-bottom : 20px">
                <div class="form-row" style="font-size : 10px">            
                        <div class="col">
                            <div class="input-select">
                            <input class="form-control" type="text" name="tag" id="tag" placeholder="URL de la légende">                          
                            </div>
                        </div>

                        <div class="col">
                            <div class="input-select">
                            <input class="form-control" type="text" name="tag" id="tag" placeholder="Phrase la plus longue">                        
                            </div>
                        </div>
                </div>
            </div>  
