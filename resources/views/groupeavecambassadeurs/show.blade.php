...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Show Groupe avec ambassadeur</h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">{{$groupeavecambassadeur->nom}}</h4>
                <p class="m-b-sm">Groupe {{$groupeavecambassadeur->actif_supprime}}</p>
                <a href="{{$groupeavecambassadeur->id_groupe}}" class="btn btn-xs btn-primary mb-3">Visiter</a>
                <br><br>
    ...
    <div class="profile-container">
                        ...
                        <table class="table table-profile">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="value">
                                        {{$groupeavecambassadeur->nom}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">ID groupe :</td>
                                    <td class="value">
                                        {{ \Str::limit($groupeavecambassadeur->id_groupe , 60) }}                            
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Personnalisation :</td>
                                    <td class="value">
                                        {{$groupeavecambassadeur->personnalisation}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Nombre de membres :</td>
                                    <td class="value">
                                        {{$groupeavecambassadeur->nb_membres}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Thème :</td>
                                    <td class="value">
                                        {{$groupeavecambassadeur->theme}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Type :</td>
                                    <td class="value">
                                        {{$groupeavecambassadeur->type}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Statut d'intégration :</td>
                                    <td class="value">
                                        {{$groupeavecambassadeur->statut_integration}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Actif/Supprimé :</td>
                                    <td class="value">
                                        {{$groupeavecambassadeur->actif_supprime}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">Fréquence post par mois :</td>
                                    <td class="value">
                                        {{$groupeavecambassadeur->frequence_post_mois}}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    ...
                    <li>
                        ...
                        <div class="value">{{$groupeavecambassadeur->statut_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Date relevé :</div>
                        <div class="value">{{$groupeavecambassadeur->date_releve}}</div>
                    </li>
                    <li>
                        <div class="field">Format groupe :</div>
                        <div class="value">{{$groupeavecambassadeur->format_groupe}}</div>
                    </li>
                    <li>
                        <div class="field">Réglementation:</div>
                        <div class="value">{{$groupeavecambassadeur->reglementation}}</div>
                    </li>
                    <li>
                        <div class="field">Lieu:</div>
                        <div class="value">
                                {{$groupeavecambassadeur->lieu}}
                        </div>
                    </li>
                    <li>
                        <div class="field">Tag recherché :</div>
                        <div class="value">
                            {{$groupeavecambassadeur->tag_recherche}}
                        </div>
                    </li>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('groupeavecambassadeurs.edit',$groupeavecambassadeur->id) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
