...
@section('content')
    ...
    <div class="container">
            ...
            <div class="card-body">
                <div class="account-settings">
                    <div class="user-profile">
                        ...
                        <h5 class="user-name">Post partagé</h5>
        ...
        <div class="card h-100">
            <div class="card-body">
            <form action="{{ route('postpartages.store') }}" method="POST">
            @csrf
                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            <label for="id_campagne"style="  color:red; font-style: italic;font-weight: bold; ">ID groupe*( obligatoire)</label>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="message_personnalise" class="form-control" placeholder="Message personnalisé">
                        </div>
                    </div>
                </div>
                <div class="row gutters">
                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="text-right">
                            ...
                            <a class="btn btn-secondary" href="{{ route('postpartages.index') }}"> Back</a>
                        </div>
                    </div>
                </div>
                </form>
