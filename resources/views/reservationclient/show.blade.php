...
<div class="container">
    <div id="content" class="content p-0">
        <div class="profile-header">
            ...
            <h2 style="margin-bottom :25px"> Fiche Suivi demande de réservation</h2>
        </div>
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about">
                            <table class="table table-profile">
                                <thead>
                                    <tr>
                                        <th colspan="2">Info Experience</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="2">Info Facture</th>
                                        </tr>
                                    </thead>
                                    <tr>
                                        <td class="field">Num_facture :</td>
                                        <td class="value">
                                            {{$value->num_facture}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">url_stripe_facture :</td>
                                        <td class="value">
                                            {{$value->url_facture}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Statut facture :</td>
                                        <td class="value">
                                            {{$value->statut_facture}}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about">
                            <table class="table table-profile">
                                <thead>
                                    <tr>
                                        <th colspan="2">Experimentateur</th>
                                    </tr>
                                </thead>
                                <tr>
                                    <td>Nom</td>
                                ...
                                <tbody>
                                    <thead>
                                        <tr>
                                            <th colspan="2">Suivi demande</th>
                                        </tr>
                                    </thead>
                                    <tr>
                                        <td class="field">Date de demande :</td>
                                        <td class="value">
                                            111111111
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Date de validation :</td>
                                        <td class="value">
                                            aa
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Date d'envoie de la facture :</td>
                                        <td class="value">
                                            0
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Date de Paiement :</td>
                                        <td class="value">
                                        </td>
                                    </tr>
                                </tbody>
...
<div class="h-100 d-flex align-items-center justify-content-center">
    ...
    <a href="{{ route('reservationclient.edit') }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
</div>
</div>
