...
class CreateGroupeAvecAmbassadeurTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('groupeavecambassadeurs', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('nom_ambassadeur');
            $table->string('id_ambassadeur');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('groupeavecambassadeurs');
    }
}
