...
class CreateGroupeAvecSegmentationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('groupeavecsegmentations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('groupeavecsegmentations');
    }
}
