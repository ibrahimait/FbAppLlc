...
class CreateGroupeSansAmbassadeurTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('groupesansambassadeurs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('groupesansambassadeurs');
    }
}
