...
class CreateAdhmanuelleTable extends Migration
{
    /**
     * Run the migrations.
     * @return void
    ...
    public function up()
    {
        Schema::create('adhmanuelles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('adhmanuelles');
    }
}
